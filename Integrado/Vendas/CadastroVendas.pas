...
begin
     ...
     DbVendas1.Qitemvenda.sql.Add('CREATE TABLE IF NOT EXISTS temp."#vendas"');
     DbVendas1.Qitemvenda.sql.Add('(idvenda integer,idcliente integer,vlvenda real ,dtcadastro date,dtvenda date,nrdocumento integer)');
     ...
     DbVendas1.Qitemvenda.sql.Add('(idvendaitem integer DEFAULT nextval($$temp."#itemvenda_iditemvenda_seq"$$::regclass),CONSTRAINT "#vendasitem_pkey" PRIMARY KEY (idvendaitem),');
     DbVendas1.Qitemvenda.sql.Add('vlunitario real, vlitem real,idproduto integer,qtitem integer,idvenda integer)');
     DbVendas1.Qitemvenda.ExecSQl;
