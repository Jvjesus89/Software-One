...
type
  TDbFinAreceber1 = class(TForm)
    ...
    QEdiçãoAreceberdtbaixa: TDateField;
    QEdiçãoAreceberidcontabancaria: TIntegerField;
    ...
    DsQAreceberEdição: TDataSource;
    QediçãoTituloAreceber: TFDQuery;
