...
begin
      ...
      DbFinAreceber1.QEdiçãoAreceber.sql.Add('Update areceber SET vltitulo=:Pvltitulo, nrtitulo=:Pnrtitulo, dtvencimento=:Pdtvencimento Where idareceber =:Pidtitulo');
