...
procedure TDbConfig.MprazoAfterCancel(DataSet: TDataSet);
begin
    Mprazo.CancelUpdates;
end;

procedure TDbConfig.MprazoAfterDelete(DataSet: TDataSet);
begin
   Mprazo.ApplyUpdates(-1);
end;

procedure TDbConfig.MprazoAfterPost(DataSet: TDataSet);
begin
    Mprazo.ApplyUpdates(-1);
end;
